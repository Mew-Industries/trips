 ...
 *
 *   node china/scripts/check_no_prices.js
 *
...
const ALLOW = [
  // China hoy no muestra ningún importe. Si aparece uno legítimo (algo que se paga
  // en destino, nunca una reserva nuestra), declararlo acá con su motivo.
];
