...
sin cancelarlo. (Actualización 3/9 · task 585: Koyasan volvió a la cadena como destino
firme 10-11 nov — hoy NO hay ningún nodo `pendiente`; el mecanismo queda documentado para
la próxima parada que entre en ese limbo.) El tercer tipo de nodo:
